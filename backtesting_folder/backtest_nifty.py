...
def get_strategy_stats(selected_dte,start_time, end_time, strike_distance, sl_percent, max_loss_points, target_points, get_trades = False):
    ...
    bnf_data_path = os.path.join(data_path, "nifty", day_wise_pkl_path)
    bnf_spot_path = os.path.join(data_path, "nifty", "nifty_spot.pkl")
    bnf_folder = os.path.join(data_path, "nifty")
    ...
    trades_df['pnl'] = trades_df['pnl'] * 50
